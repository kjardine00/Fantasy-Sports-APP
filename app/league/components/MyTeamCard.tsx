...
const MyTeamCard = () => {
  const { league, membership, profile } = useLeague();
    ...
    <div className="sidebar-container card w-full lg:w-80 bg-base-100 shadow-lg">
      <div className="card-body">
        ...
        <div className="text-center">
          <Link
            href={`/team?leagueId=${league.id}&teamId=${membership.league_number}`}
          >
            <img
              src={membership.team_icon || "/icons/baseball-bat.svg"}
              alt="team-logo"
          ...
          <div className="py-4">
            <h2 className="text-2xl font-bold">{membership.team_name}</h2>
